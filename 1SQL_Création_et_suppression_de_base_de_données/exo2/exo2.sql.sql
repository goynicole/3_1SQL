...
/****** Object:  Database [webDevelopment]    Script Date: 21/01/2019 12:08:42 ******/
CREATE DATABASE [webDevelopment]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'webDevelopment', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQL\DATA\webDevelopment.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'webDevelopment_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQL\DATA\webDevelopment_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [webDevelopment] SET COMPATIBILITY_LEVEL = 120
GO
...
ALTER DATABASE [webDevelopment] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [webDevelopment] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
